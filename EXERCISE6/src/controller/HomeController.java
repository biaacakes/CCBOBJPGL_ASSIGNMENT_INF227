...
public class HomeController implements Initializable {
    ...
    static TallLamp tlamp= new TallLamp();
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        // ============== TALL LAMP ==================//
        tlamp.setProductName("Tall Lamp");
        name4.setText(tlamp.getProductName());
 
        tlamp.setProductPrice(16.00);
        price4.setText(Double.toString(tlamp.getProductPrice()));
 
        tlamp.setProductImage("images/lamp4.jpg");
        Image tallLamp = new Image(tlamp.getProductImage());
        img4.setImage(tallLamp);
